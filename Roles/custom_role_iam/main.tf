...
/******************************************
  Permissions unsupported for custom roles (Pull Unsupported Roles)
 *****************************************/
...
/******************************************
  Custom IAM Org Role (Organization Scope)
 *****************************************/
...
/******************************************
  Assigning custom_role to member (Org)
 *****************************************/
...
/******************************************
  Custom IAM Project Role (Project Scope)
 *****************************************/
...
/******************************************
  Assigning custom_role to member (Project)
 *****************************************/
