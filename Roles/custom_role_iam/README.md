...
## Original Repo -> terraform-google-iam/modules/custom_role_iam
The module you see is taken from terraform-google-iam for test purposes. 

## Usage - Custom Role at Organization Level

```hcl
module "custom-roles" {
  source = "github.com/asrinandirin/GCP-IAM/Roles/custom_role_iam"
